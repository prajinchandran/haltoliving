      ...
      <div className="page-body">
        ...
        <div className="toolbar">
          <select className="fs" style={{ width: 110 }} value={year} onChange={e => setYear(+e.target.value)}>
            {[2023, 2024, 2025, 2026].map(y => <optio n key={y}>{y}</option>)}
          </select>
...
// ─── App Shell ────────────────────────────────────────────────────────────────
const NAV = [
  { id: "dashboard", icon: "⊞", label: "Dashboard", roles: ["OrganizationOwner", "OrganizationStaff", "SuperAdmin"] },
  { id: "categories", icon: "🏷", label: "Categories", roles: ["OrganizationOwner", "OrganizationStaff", "SuperAdmin"] },
  { id: "members", icon: "◉", label: "Members", roles: ["OrganizationOwner", "OrganizationStaff", "SuperAdmin"] },
  { id: "dues", icon: "◌", label: "Dues", roles: ["OrganizationOwner", "OrganizationStaff", "SuperAdmin"] },
  { id: "payments", icon: "●", label: "Payments", roles: ["OrganizationOwner", "OrganizationStaff", "SuperAdmin"] },
  { id: "staff", icon: "⬡", label: "Staff", roles: ["OrganizationOwner", "SuperAdmin"] },
];
    ...
    <div className="app">
      <nav className="sidebar">
        <div className="sb-logo">
          ...
          <div className="sb-org">{user?.organizationName || "Organisation"}</div>
        </div>
        ...
        <div className="sb-footer">
          <div className="user-pill">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div className="u-role">{user?.role === "OrganizationOwner" ? "Owner" : "Staff"}</div>
            </div>
